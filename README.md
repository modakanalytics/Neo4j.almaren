...
```
spark-shell --master "local[*]" --packages "com.github.music-of-the-ainur:almaren-framework_2.11:0.9.3-2.4,com.github.music-of-the-ainur:neo4j-almaren_2.11:0.1.1-2.4"
```
