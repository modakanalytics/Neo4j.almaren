...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "neo4j-almaren" % "0.1.4-3.1"
```
...
```
spark-shell --master "local[*]" --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.10-3.1,com.github.music-of-the-ainur:neo4j-almaren_2.12:0.1.4-3.1"
```
